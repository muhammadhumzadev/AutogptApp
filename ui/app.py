...
with gr.Blocks(css=CSS) as app:
    with gr.Column() as setup_pane:
        gr.Markdown(f"""# AIOS-Agent
        1. Enter your <a href="https://platform.openai.com/account/api-keys">OpenAI API Key</a> below.
        """)
        with gr.Row():
...
app.queue(concurrency_count=20).launch(file_directories=[OUTPUT_DIR], server_name="0.0.0.0", server_port=7860)
